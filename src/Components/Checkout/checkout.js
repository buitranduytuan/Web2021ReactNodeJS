                                    ...
                                    <tbody>
                                        <tr className="rem1">
                                            ...
                                            <td className="invert-image">
                                                <a href="single.html">
                                                    <img src="/asset/images/a.jpg" alt=" " className="img-responsive" />
                                                </a>
                                            </td>
                                            <td className="invert">
                                        ...
                                        <tr className="rem2">
                                            ...
                                            <td className="invert-image">
                                                <a href="single2.html">
                                                    <img src="/asset/images/a4.jpg" alt=" " className="img-responsive" />
                                                </a>
                                            </td>
                                            <td className="invert">
                                                <div className="quantity">
                                        ...
                                        <tr className="rem3">
                                            ...
                                            <td className="invert-image">
                                                <a href="single.html">
                                                    <img src="/asset/images/a3.jpg" alt=" " className="img-responsive" />
                                                </a>
                                            </td>
                                            <td className="invert">
                                                <div className="quantity">

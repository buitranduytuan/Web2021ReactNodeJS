                                            ...
                                            <div className="scroll">
                                                <div className="row">
                                                    <div className="col-lg-3 col-sm-2 col-3 left-mar">
                                                        <img src={path + "/images/k1.jpg"} alt="" className="img-fluid" />
                                                    </div>
                                                ...
                                                <div className="row my-4">
                                                    <div className="col-lg-3 col-sm-2 col-3 left-mar">
                                                        <img src={path + "/images/k2.jpg"} alt="" className="img-fluid" />
                                                    </div>
                                                    <div className="col-lg-9 col-sm-10 col-9 w3_mvd">
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-3 col-sm-2 col-3 left-mar">
                                                        <img src={path + "/images/k3.jpg"} alt="" className="img-fluid" />
                                                    </div>
                                                    <div className="col-lg-9 col-sm-10 col-9 w3_mvd">
